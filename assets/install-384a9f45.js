import{a as h,e as v,i as r,c as s,t as m,f as d,g as f,d as e,$ as i,v as b}from"./index-58cc0a3f.js";const w=m('<button><div text-base=""></div></button>',4),N=m('<div grid="" gap-5=""><div class="[&amp;_*]:rounded-lg [&amp;_button]:p-3 [&amp;_button]:w-fit vertCentered !gap-3"></div><pre class="hljs"></pre></div>',6),[_,C]=h("Linux / Macos"),p="git clone https://github.com/NvChad/NvChad ~/.config/nvim --depth 1 && nvim",k="git clone https://github.com/NvChad/NvChad $HOME\\AppData\\Local\\nvim --depth 1 && nvim",x=`docker run -w /root -it --rm alpine:latest sh -uelic '
